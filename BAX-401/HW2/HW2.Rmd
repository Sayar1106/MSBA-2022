...
## Synergy
```{r}
step_model_synergy <-step(lm(df$`Sales (units)` ~ df$Catalogs_Winback + df$Catalogs_NewCust + df$Search + df$Retargeting + df$lagSales + df$Catalogs_Winback * df$Catalogs_NewCust + df$Catalogs_Winback * df$Search + df$Catalogs_Winback * df$Retargeting + df$Catalogs_Winback + df$Catalogs_NewCust * df$Search + df$Catalogs_NewCust * df$Retargeting + df$Search*df$Retargeting - 1), direction="backward")
